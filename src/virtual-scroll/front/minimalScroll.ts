/*
 ...
 taken from https://github.com/RaduW/minimal-scroll
 */
...
export function scrollToTop(elm?:HTMLElement|null, parent?:HTMLElement|null) {
  ...
  if (!elm || !parent){
    logWarn( "scrollToTop called with "+!elm ? "null elm ": "null parent ")
    return
  }
...
export function scrollToBottom(elm?: HTMLElement|null, parent?: HTMLElement|null) {

  if (!elm || !parent){
    logWarn( "scrollToBottom called with "+!elm ? "null elm ": "null parent ")
    return
  }
...
export function scrollToCenter(elm?: HTMLElement|null, parent?: HTMLElement|null, minimal: boolean = true) {
  if (!elm || !parent){
    logWarn( "scrollToCenter called with "+!elm ? "null elm ": "null parent ")
    return
  }
  const elmHeight: number = elm.offsetHeight
  const innerHeight = parent.clientHeight
...
export function minimalScroll(elm?: HTMLElement|null, parent?: HTMLElement|null) {
  if (!elm || !parent){
    logWarn( "minimalScroll called with "+!elm ? "null elm ": "null parent ")
    return
  }
